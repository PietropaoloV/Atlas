...
class SetHandler extends Handler {
   ...
   async handle(req) {
          ...
          switch (req.method) {
            ...
            case "GET":
              if (req.url.split('/').filter(Boolean).length === 3) {
                return this.GetSet(req.url.split('/')[1], req.url.split('/')[3]);
              } else {
                return this.ListSets(req.url.split('/')[1]);
              }
            case "PUT":
              return this.processBodyPush(req);
            case "DELETE":
              return this.DeleteSet(req.url.split('/')[1], req.url.split('/')[3]);
            default:
    ...
    async processBodyCreate(req){    
        ...
        return this.CreateSet(req.url.split('/')[1]);
    }
    ...
    async processBodyPush(req){    
        ...
        return this.UpdateSet(req.url.split('/')[1], req.url.split('/')[3]);
    }
