        ...
        try {
            ...
            switch (req.method) {
                case "POST":
                    ...
                    return this.createProfile(req.url.split('/')[1]);
                case "GET":
                    if (req.url.split('/').filter(Boolean).length == 3) {
                        return this.GetProfile(req.url.split('/')[1], req.url.split('/')[3]);
                    } else {
                        return this.ListProfile(req.url.split('/')[1]);
                    }
                case "PUT":
                    return this.UpdateProfile(req.url.split('/')[1], req.url.split('/')[3]);
                case "DELETE":
                    return this.DeleteProfile(req.url.split('/')[1], req.url.split('/')[3]);
                default:
